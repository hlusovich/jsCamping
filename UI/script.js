...
function createUserIconText(user) {
    const iconText = user.split(" ");
    return iconText[0][0] + iconText[1][0];

}

function createUserIconColor() {
...
class HeaderView {
    ...
    display(user) {
        if (user) {
            ...
            profileUserIcon.classList.add("user-img", "yellow");
            profileUserIcon.innerText = createUserIconText(user);
...
class MessagesView {
    ...
    display(msgs, user) {
        ...
        function createMessage(msg) {
            ...
            userImg.innerText = createUserIconText(msg.author);
            time.innerText = msg.createdAt;
            text.innerText = msg.text;
            if (colorMap[msg.author]) {
                userImg.classList.add("user-img", colorMap[msg.author]);
            } else {
              colorMap[msg.author] = createUserIconColor();
                userImg.classList.add("user-img",colorMap[msg.author] );
