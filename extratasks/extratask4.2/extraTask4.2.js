 ...
 * @param {function} one of the functions add, sub, div, mul which was called with single parameter.
 * @returns {function} which accepts a single parameter, which is the argument for the first function passed to function pipe,
 * and which:
            *@returns {number} which the result of calling functions passed to the pipe and then passing the
             result of calling each function as an argument to the next one.
  */
function pipe(...arr) {
